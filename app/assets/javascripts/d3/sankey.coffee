    ...
    sankey:
      data:
        nodes: [
          ...
          {id: 'p2h_central_heat',             column: 2, label: 'p2h_central_heat',       color: '#6c5ce7'},
          ...
          {id: 'p2h_industry',                 column: 3, label: 'p2h_industry',           color: '#6c5ce7'},
        ...
        links: [
          ...
          {left: 'electricity_prod',              right: 'p2h_central_heat', gquery: 'electricity_prod_to_p2h_central_heat_in_sankey', color: '#1f77b4'},
          {left: 'electricity_prod',              right: 'p2h_industry',     gquery: 'electricity_prod_to_p2h_industry_in_sankey', color: '#1f77b4'},
          ...
          {left: 'p2h_central_heat',              right: 'central_heat_prod', gquery: 'p2h_central_heat_to_central_heat_in_sankey', color: '#d62728'},
          {left: 'p2h_central_heat',              right: 'conversion_losses', gquery: 'p2h_central_heat_to_conversion_loss_in_sankey', color: '#DCDCDC'},
          ...
          #{left: 'geo_ambient',                   right: 'households',       gquery: 'geo_ambient_to_households_in_sankey', color: '#787821'},
          #{left: 'geo_ambient',                   right: 'buildings',        gquery: 'geo_ambient_to_buildings_in_sankey', color: '#787821'},
          #{left: 'geo_ambient',                   right: 'transport',        gquery: 'geo_ambient_to_transport_in_sankey', color: '#787821'},
          #{left: 'geo_ambient',                   right: 'industry',         gquery: 'geo_ambient_to_industry_in_sankey', color: '#787821'},
          #{left: 'geo_ambient',                   right: 'agriculture',      gquery: 'geo_ambient_to_agriculture_in_sankey', color: '#787821'},
          #{left: 'geo_ambient',                   right: 'other',            gquery: 'geo_ambient_to_other_in_sankey', color: '#787821'},
          {left: 'geo_ambient',                   right: 'p2h_central_heat', gquery: 'geo_ambient_to_p2h_central_heat_in_sankey', color: '#787821'},
